...
# Define file paths
# eGFR_file <- "Z:\\f.afsari\\4-DUET\\database\\eGFR Correlation\\ExcelFiles\\eGFR Test Values Structured Version.xlsx"
eGFR_file <- "Z:\\f.afsari\\4-DUET\\database\\eGFR Correlation\\Tx_data\\combined_t0_refFeatures_SCr_eGFR 2.xlsx"
collagen_file <- "Z:\\f.afsari\\4-DUET\\database\\eGFR Correlation\\ExcelFiles\\Collagen_Features.xlsx" 

# Read the Excel files
eGFR_data <- read_excel(eGFR_file)
...
transplant_date_column <- grep("eGFR_3mo", colnames(eGFR_data), value=TRUE)
...
write.csv(eGFR_long, file = "Z:\\f.afsari\\4-DUET\\database\\eGFR Correlation\\eGFR_long_data.csv")
