...
patches_dir = f"{base_path}/Prediction Masks/{case_ID}/Results/Ensemble_MIT_RGB/Pred"
# patches_dir = base_path+"/Patches/C"
output_dir = f"{base_path}/Prediction Masks/{case_ID}/Results/Ensemble_MIT_RGB/WSI" 
